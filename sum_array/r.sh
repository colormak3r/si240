...
echo "Compile the source file manager.c"
gcc  -m64 -Wall -no-pie -o manager.o -std=c2x -c manager.c

echo "Compile the source file input_array.c"
gcc  -m64 -Wall -no-pie -o input_array.o -std=c2x -c input_array.c

echo "Compile the source file sort.c"
gcc  -m64 -Wall -no-pie -o sort.o -std=c2x -c sort.c

echo "Compile the source file sum.c"
gcc  -m64 -Wall -no-pie -o sum.o -std=c2x -c sum.c
...
#echo "Compile the source file isinteger.c"
#gcc  -m64 -Wall -no-pie -o isinteger.o -std=c2x -c isinteger.c
