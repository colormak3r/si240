...
nasm -f elf64 -l average.lis -o average.o average.asm -gdwarf

echo "Compile the source file driver.c"
gcc  -m64 -Wall -no-pie -o driver.o -std=c2x -c driver.c -g

echo "Link the object modules to create an executable file"
gcc -m64 -no-pie -o learn.out average.o driver.o -std=c2x -Wall -z noexecstack -g
