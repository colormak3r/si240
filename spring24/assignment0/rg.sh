...
nasm -f elf64 -gdwarf -l hello.lis -o hello.o helloworld.asm

echo "Compile the source file beginhere.c"
gcc  -m64 -g -Wall -no-pie -o begin.o -std=c2x -c beginhere.c

echo "Link the object modules to create an executable file"
gcc -m64 -g -no-pie -o learn.out hello.o begin.o -std=c2x -Wall -z noexecstack
