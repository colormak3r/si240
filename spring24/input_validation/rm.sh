...
echo "Assemble the source file valid_mem.asm"
nasm -f elf64 -l valid_mem.lis -o valid_mem.o valid_mem.asm
...
gcc -m64 -no-pie -o learn.out isfloat.o valid_mem.o driver.o -std=c2x -Wall -z noexecstack -lm
